...
namespace CursoCSharp.Fundamentos
{
    internal class Conversoes
    {
        public static void Executar()
        {
            ...
            float valor1float = (float)valor1;

            Console.WriteLine(valor1float);


            Console.WriteLine("Digite um número: ");
            int.TryParse(Console.ReadLine(), out int numerodig);
            Console.WriteLine("O numero digitado somado com 10 é: {0}", numerodig + 10);
